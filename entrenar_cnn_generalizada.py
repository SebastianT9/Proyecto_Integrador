...
# --- 6. ARQUITECTURA OPTIMIZADA DE LA CNN CON DATA AUGMENTATION ---
print("🧠 Construyendo la arquitectura optimizada de la CNN...")

# Definimos el bloque de aumento de datos (solo se aplica en el entrenamiento)
...
model = models.Sequential([
    # Capa de entrada y aumento de datos
...
# Compilar con la misma configuración básica
model.compile(optimizer='adam',
              loss='sparse_categorical_crossentropy',
              metrics=['accuracy'])

# Configurar Parada Temprana para restaurar el mejor modelo automáticamente
...
# --- 7. ENTRENAMIENTO EXTENDIDO ---
print("🏋️ Entrenando la CNN optimizada (Máximo 50 épocas)...")
...
# --- 8. EVALUACIÓN FINAL CORREGIDA (SIN FALLOS) ---
val_loss, val_acc = model.evaluate(X_val, y_val, verbose=0)

print("\n" + "="*50)
print("📊 REPORTE DE RENDIMIENTO DIRECTO - MODELO: CNN OPTIMIZADA")
print("="*50)
...
print(f"🔹 Tiempo total de procesamiento: {cnn_execution_time:.4f} segundos")
print("="*50 + "\n")

# Guardar el nuevo modelo mejorado
model.save(os.path.join(output_folder, "modelo_etnias_cnn_generalizada.h5"))
print(f"💾 Modelo optimizado guardado exitosamente.")