...
print("🚀 Extrayendo vectores HOG optimizados...")
...
for filename in os.listdir(input_folder):
    if filename.lower().endswith(('.jpg', '.jpeg', '.png', '.bmp')):
        ...
        try:
            ...
            # Filtro bilateral para preservar bordes eliminando ruido de alta frecuencia
...
print("\n" + "="*50)
print("📊 REPORTE TÉCNICO COMPLETO - DESCRIPTOR: HOG")
print("="*50)
print(f"🔹 Dimensiones del dataset: {df_hog.shape[0]} muestras x {df_hog.shape[1] - 1} características")
